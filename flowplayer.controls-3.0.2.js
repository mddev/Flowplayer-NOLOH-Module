 ...
 * Revision: 1424 
 */ 
$f.addPlugin("controls", function(wrap, cenbool) {
...
//{{{ private functions
	...
	function Draggable(o, min, max, offset) { 
		...
		function move(x) {
			...
			if (x > max) { 		pause.className = opts.playClass;
								return false; }
			if (x < min) { pause.className = opts.playClass; return false; } 
			o.style.left = x + "px";	
			return true;
		}
	...
	var opts = {
		...
		template: '<a class="play">play</a>' + 
					 '<div class="track">' +
						...
						'<div class="inmarker"></div>' +
						'<div class="outmarker"></div>' +
